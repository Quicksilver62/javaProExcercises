...
import ru.vtb.javaproexcercises.ex05.controller.UserController;
...
public class UserControllerTest {
    ...
    void findUserByIdTest() throws Exception {
        ...
        mockMvc.perform(get("/api/users/{id}", userDto.id()))
    ...
    void createUserTest() throws Exception {
        ...
        mockMvc.perform(post("/api/users/create", userDto))
    ...
    void deleteUserTest() throws Exception {
        ...
        mockMvc.perform(delete("/api/users/delete", userDto))
